...
**[Live essay →](https://YOUR-USERNAME.github.io/tick-coyote-deer/)**
...
```bash
git clone https://github.com/YOUR-USERNAME/tick-coyote-deer.git
cd tick-coyote-deer
...
4. Live at `https://YOUR-USERNAME.github.io/tick-coyote-deer/`.
...
> *The Tick, the Coyote, and the Deer: An Interactive Essay on Predator–Prey Dynamics and Suffering* (2026). https://YOUR-USERNAME.github.io/tick-coyote-deer/
